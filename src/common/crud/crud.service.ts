...
@Injectable()
export class CrudService<Entity, Repository extends ICrudRepository<Entity, Create, Update>, Create, Update> {
    constructor(protected readonly repository: Repository) { }
    async findPaginated(paginatedOptions: PaginatedOptionsDto, tenantId: string): Promise<PaginatedResponseDto<Entity>> {
