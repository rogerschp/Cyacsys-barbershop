...
export class CrudController<Entity, Service extends CrudService<Entity, Repository, Create, Update>, Repository extends ICrudRepository<Entity, Create, Update>, Create, Update> {
    ...
    @Req()
    req: any): Promise<PaginatedResponseDto<Entity>> {
