...
class TestCrudController extends CrudController<MockEntity, CrudService<MockEntity, ICrudRepository<MockEntity, any, any>, any, any>, ICrudRepository<MockEntity, any, any>, any, any> {
    constructor(service: CrudService<MockEntity, ICrudRepository<MockEntity, any, any>, any, any>) {
        super(service);
    }
}
describe('CrudController (HTTP)', () => {
    let app: INestApplication;
    let crudService: jest.Mocked<CrudService<MockEntity, ICrudRepository<MockEntity, any, any>, any, any>>;
    ...
    describe('GET /test-crud/:id (findOne)', () => {
        it('deve retornar 200 e a entidade', () => {
            ...
            return request(app.getHttpServer())
                ...
                expect(crudService.findOne).toHaveBeenCalledWith('entity-1', 'tenant-1');
            });
        });
    });
    describe('POST /test-crud (create)', () => {
        it('deve retornar 201 e a entidade criada', () => {
            ...
            return request(app.getHttpServer())
                ...
                expect(res.body).toHaveProperty('name', 'Test Entity');
                expect(crudService.create).toHaveBeenCalledWith({ name: 'Test Entity' }, 'tenant-1');
            });
        });
    });
    describe('PATCH /test-crud/:id (update)', () => {
        it('deve retornar 200 e a entidade atualizada', () => {
            ...
            return request(app.getHttpServer())
                ...
                expect(crudService.update).toHaveBeenCalledWith('entity-1', { name: 'Updated' }, 'tenant-1');
            });
        });
    });
