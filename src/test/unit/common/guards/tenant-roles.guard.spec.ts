...
import { RequestWithTenantRole, TenantRolesGuard, } from 'src/common/guards/tenant-roles.guard';
import { TenantUserRole } from 'src/modules/tenant-user/entities/tenant-user-role.enum';
describe('TenantRolesGuard', () => {
    let guard: TenantRolesGuard;
    let reflector: Reflector;
    const createMockContext = (overrides: Partial<RequestWithTenantRole> = {}): ExecutionContext => {
