...
describe('TenantUserRepository', () => {
    ...
    beforeEach(async () => {
        ...
        typeOrmRepo = module.get(getRepositoryToken(TenantUserEntity)) as jest.Mocked<Repository<TenantUserEntity>>;
    });
    ...
    describe('findByTenantAndUser', () => {
        it('deve retornar o vinculo quando existe', async () => {
            ...
            const result = await repository.findByTenantAndUser('tenant-uuid', 'user-uuid');
