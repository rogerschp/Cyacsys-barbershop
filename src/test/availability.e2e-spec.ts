...
describe('AvailabilityController (e2e)', () => {
  ...
  beforeAll(async () => {
      ...
      providers: [
        {
          ...
          useValue: mocks.createProfessionalServiceLink,
        },
        {
          provide: UpdateProfessionalServiceLinkUseCase,
          useValue: mocks.updateProfessionalServiceLink,
        },
        {
          provide: DeleteProfessionalServiceLinkUseCase,
          useValue: mocks.deleteProfessionalServiceLink,
        },
        {
          provide: ListProfessionalServiceLinksUseCase,
          useValue: mocks.listProfessionalServiceLinks,
        },
        {
          provide: CreateWorkingHoursUseCase,
          useValue: mocks.createWorkingHours,
        },
        {
          provide: UpdateWorkingHoursUseCase,
          useValue: mocks.updateWorkingHours,
        },
        {
          provide: DeleteWorkingHoursUseCase,
          useValue: mocks.deleteWorkingHours,
        },
        ...
        { provide: GetWorkingHoursUseCase, useValue: mocks.getWorkingHours },
        {
          ...
          useValue: mocks.createWorkingHoursPeriod,
        },
        {
          provide: UpdateWorkingHoursPeriodUseCase,
          useValue: mocks.updateWorkingHoursPeriod,
        },
        {
          provide: DeleteWorkingHoursPeriodUseCase,
          useValue: mocks.deleteWorkingHoursPeriod,
        },
        ...
        { provide: ListBlocksUseCase, useValue: mocks.listBlocks },
        {
          ...
          useValue: mocks.getAvailableSlots,
        },
        {
          provide: BootstrapWorkingWeekUseCase,
          useValue: mocks.bootstrapWorkingWeek,
        },
      ],
    })
    ...
    await app.init();
    getAvailableSlotsUseCase = moduleFixture.get(
      GetAvailableSlotsUseCase,
    ) as jest.Mocked<GetAvailableSlotsUseCase>;
    createProfessionalServiceLinkUseCase = moduleFixture.get(
      CreateProfessionalServiceLinkUseCase,
    ) as jest.Mocked<CreateProfessionalServiceLinkUseCase>;
    listProfessionalServiceLinksUseCase = moduleFixture.get(
      ListProfessionalServiceLinksUseCase,
    ) as jest.Mocked<ListProfessionalServiceLinksUseCase>;
    createWorkingHoursUseCase = moduleFixture.get(
      CreateWorkingHoursUseCase,
    ) as jest.Mocked<CreateWorkingHoursUseCase>;
    listWorkingHoursUseCase = moduleFixture.get(
      ListWorkingHoursUseCase,
    ) as jest.Mocked<ListWorkingHoursUseCase>;
    createBlockUseCase = moduleFixture.get(
      CreateBlockUseCase,
    ) as jest.Mocked<CreateBlockUseCase>;
    createTimeOffUseCase = moduleFixture.get(
      CreateTimeOffUseCase,
    ) as jest.Mocked<CreateTimeOffUseCase>;
  });
  afterAll(async () => {
  ...
  beforeEach(() => {
    ...
    createProfessionalServiceLinkUseCase.run.mockResolvedValue({
      id: 'link-1',
    } as any);
  ...
  describe(`POST ${basePath}/offered-services`, () => {
    it('deve retornar 201 e chamar use case', () => {
      return request(app.getHttpServer())
        ...
        .expect(201)
        .expect(() => {
          expect(createProfessionalServiceLinkUseCase.run).toHaveBeenCalledWith(
            tenantId,
            tenantProfessionalId,
  ...
  describe(`GET ${basePath}/working-hours`, () => {
    it('deve retornar 200 e lista', () => {
      return request(app.getHttpServer())
        ...
        .expect(200)
        .expect(() => {
          expect(listWorkingHoursUseCase.run).toHaveBeenCalledWith(
            tenantId,
            tenantProfessionalId,
            'user-e2e-123',
            TenantUserRole.ADMIN,
  ...
  describe(`POST ${basePath}/working-hours`, () => {
    it('deve retornar 201 quando body válido', () => {
      return request(app.getHttpServer())
        ...
        .expect(201)
        .expect(() => {
          expect(createWorkingHoursUseCase.run).toHaveBeenCalledWith(
            tenantId,
            tenantProfessionalId,
  ...
  describe(`POST ${basePath}/blocks`, () => {
    it('deve retornar 201 quando body válido', () => {
      return request(app.getHttpServer())
        ...
        .expect(201)
        .expect(() => {
          expect(createBlockUseCase.run).toHaveBeenCalledWith(
            tenantId,
            tenantProfessionalId,
            expect.objectContaining({ reason: BlockReason.LUNCH }),
            'user-e2e-123',
            TenantUserRole.ADMIN,
          );
        });
  ...
  describe(`POST ${basePath}/time-offs`, () => {
    it('deve retornar 201 para folga dia inteiro', () => {
      return request(app.getHttpServer())
        ...
        .expect(201)
        .expect(() => {
          expect(createTimeOffUseCase.run).toHaveBeenCalledWith(
            tenantId,
            tenantProfessionalId,
