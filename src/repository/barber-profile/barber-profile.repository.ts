...
import { CreateBarberProfileData, IBarberProfileRepository, UpdateBarberProfileData, } from '../../modules/barber-profile/interfaces/barber-profile-repository.interface';
@Injectable()
export class BarberProfileRepository implements IBarberProfileRepository {
    ...
    async findById(id: string, tenantId: string): Promise<BarberProfileEntity | null> {
        return this.repo.findOne({
            where: { id, tenantId },
            withDeleted: false,
        });
    }
    async findByTenantUserIdNonDeleted(tenantId: string, tenantUserId: string): Promise<BarberProfileEntity | null> {
        return this.repo
    ...
    async update(id: string, tenantId: string, data: UpdateBarberProfileData): Promise<BarberProfileEntity> {
