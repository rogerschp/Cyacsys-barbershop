...
import { CreateServiceData, IServiceRepository, UpdateServiceData, } from '../../modules/service/interfaces/service-repository.interface';
@Injectable()
export class ServiceRepository implements IServiceRepository {
    ...
    async findNonDeletedByName(tenantId: string, name: string, excludeId?: string): Promise<ServiceEntity | null> {
        const qb = this.repo
    ...
    async update(id: string, tenantId: string, data: UpdateServiceData): Promise<ServiceEntity> {
