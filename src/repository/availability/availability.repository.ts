...
export class AvailabilityRepository implements IAvailabilityRepository {
  ...
  async findBarberServiceLinkById(
    id: string,
    tenantId: string,
  ...
  async findBarberServiceLinkByBarberAndService(
  ...
  async listBarberServiceLinksByBarber(
    barberProfileId: string,
    tenantId: string,
  ): Promise<BarberServiceLinkEntity[]> {
  ...
  async updateBarberServiceLink(
    ...
    if (!e) throw new Error('Barber service link not found after update');
    return e;
  }

  async softDeleteBarberServiceLink(
    id: string,
    tenantId: string,
  ): Promise<BarberServiceLinkEntity> {
    const e = await this.findBarberServiceLinkById(id, tenantId);
    if (!e) throw new Error('Barber service link not found');
  ...
  async findWorkingHoursByBarberAndDay(
    barberProfileId: string,
    tenantId: string,
    dayOfWeek: DayOfWeek,
    withPeriods = false,
  ...
  async listWorkingHoursByBarber(
    barberProfileId: string,
    tenantId: string,
  ): Promise<WorkingHoursEntity[]> {
  ...
  async updateWorkingHours(
    ...
    if (!e) throw new Error('Working hours not found after update');
    return e;
  }
  ...
  async softDeleteWorkingHours(id: string, tenantId: string): Promise<void> {
    ...
    if (!wh) throw new Error('Working hours not found');
  ...
  async updateTimeOff(
    ...
    if (!e) throw new Error('Time off not found after update');
    return e;
  }
  ...
  async softDeleteTimeOff(
    ...
    const e = await this.findTimeOffById(id, tenantId);
    if (!e) throw new Error('Time off not found');
  ...
  async updateBlock(
    ...
    if (!e) throw new Error('Block not found after update');
    return e;
  }
