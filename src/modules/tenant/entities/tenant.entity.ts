...
export class TenantEntity {
    ...
    @ApiProperty({
        ...
        description: 'Identidade pública na URL. Único globalmente e imutável após criação.',
    })
    slug: string;
    @Column()
    @ApiProperty({
    ...
    @ApiProperty({
        enum: TenantStatus,
        description: 'ACTIVE = operação normal; INACTIVE = desativado; SUSPENDED = bloqueio (inadimplência/manual)',
    })
    status: TenantStatus;
