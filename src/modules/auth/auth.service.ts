...
import { TOKEN_VERIFIER, ITokenVerifier, } from './interfaces/token-verifier.interface';
@Injectable()
export class AuthService {
    ...
    private readonly tokenVerifier: ITokenVerifier, private readonly userService: UserService) { }
    async authenticateWithUserCredentials(authLoginDto: AuthLoginDto): Promise<AuthLoginResponseDto> {
        const tokens = await this.authProvider.authenticateWithCredentials(authLoginDto);
