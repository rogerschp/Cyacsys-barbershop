...
export class ListTimeOffsUseCase {
  ...
  async run(tenantId: string, tenantProfessionalId: string, userId: string, callerRole?: string): Promise<TimeOffEntity[]> {
        ...
        return this.availabilityRepository.listTimeOffsByProfessional(tenantProfessionalId, tenantId);
    }
}
