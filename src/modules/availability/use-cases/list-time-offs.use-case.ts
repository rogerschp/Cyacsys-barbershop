...
export class ListTimeOffsUseCase {
    ...
    async run(tenantId: string, barberProfileId: string, userId: string, callerRole?: string): Promise<TimeOffEntity[]> {
        ...
        return this.availabilityRepository.listTimeOffsByBarber(barberProfileId, tenantId);
    }
}
