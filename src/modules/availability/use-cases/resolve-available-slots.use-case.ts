...
/**
 * Núcleo de domínio da disponibilidade de slots (sem regra de membership/agenda).
 * Usado por fluxo ops e por fluxo client.
 */
@Injectable()
export class ResolveAvailableSlotsUseCase {
  constructor(
  ...
  async run(
    ...
    return { date: dateYmd, timezone, slots: [...slotSet].sort() };
  }
}
