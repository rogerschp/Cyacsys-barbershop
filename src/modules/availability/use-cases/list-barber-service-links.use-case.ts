...
@Injectable()
export class ListBarberServiceLinksUseCase {
    constructor(
    ...
    async run(tenantId: string, barberProfileId: string, userId: string, callerRole?: string): Promise<BarberServiceLinkEntity[]> {
        ...
        return this.availabilityRepository.listBarberServiceLinksByBarber(barberProfileId, tenantId);
    }
}
