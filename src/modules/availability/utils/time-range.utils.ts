...
/** Minutos desde meia-noite; intervalos de período usam [start, end) com end exclusivo. */
...
/** [aStart, aEnd) sobrepõe [bStart, bEnd)? */
...
/** Normaliza coluna date do PG (Date ou string yyyy-MM-dd). */
