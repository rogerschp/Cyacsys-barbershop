...
export interface ITenantUserRepository {
    ...
    findByIdAndTenant(id: string, tenantId: string): Promise<TenantUserEntity | null>;
    findByTenantAndUser(tenantId: string, userId: string): Promise<TenantUserEntity | null>;
