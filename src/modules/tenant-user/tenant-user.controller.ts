...
export class TenantUserController {
    ...
    @ApiOperation({
        ...
        description: 'Adiciona um usuário como membro do tenant com o papel indicado. Tenant e usuário devem existir; não permite vínculo duplicado.',
    })
    ...
    dto: AddMemberToTenantDto) {
        return this.tenantUserService.addUserToTenant(dto.userId, tenantId, dto.role);
    }
    @Get(':userId')
    @ApiOperation({
