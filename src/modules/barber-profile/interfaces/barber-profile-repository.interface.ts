...
export interface IBarberProfileRepository {
    ...
    findByTenantUserIdNonDeleted(tenantId: string, tenantUserId: string): Promise<BarberProfileEntity | null>;
    listByTenant(tenantId: string): Promise<BarberProfileEntity[]>;
    update(id: string, tenantId: string, data: UpdateBarberProfileData): Promise<BarberProfileEntity>;
