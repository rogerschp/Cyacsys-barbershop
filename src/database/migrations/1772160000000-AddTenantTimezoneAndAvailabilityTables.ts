...
export class AddTenantTimezoneAndAvailabilityTables1772160000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "tenants" ADD "timezone" character varying(64) NOT NULL DEFAULT 'America/Sao_Paulo'`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_working_hours_tenant_id" ON "working_hours" ("tenant_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_working_hours_barber_profile_id" ON "working_hours" ("barber_profile_id")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_working_hours_periods_wh_id" ON "working_hours_periods" ("working_hours_id")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_barber_time_offs_tenant_id" ON "barber_time_offs" ("tenant_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_barber_time_offs_barber_date" ON "barber_time_offs" ("barber_profile_id", "date")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_barber_availability_blocks_tenant_id" ON "barber_availability_blocks" ("tenant_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_barber_availability_blocks_barber_date" ON "barber_availability_blocks" ("barber_profile_id", "date")`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_barber_services_tenant_id" ON "barber_services" ("tenant_id")`);
        await queryRunner.query(`CREATE INDEX "IDX_barber_services_barber_profile_id" ON "barber_services" ("barber_profile_id")`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_services_barber_profile_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_services_tenant_id"`);
        await queryRunner.query(`DROP TABLE "barber_services"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_availability_blocks_barber_date"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_availability_blocks_tenant_id"`);
        await queryRunner.query(`DROP TABLE "barber_availability_blocks"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_time_offs_barber_date"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_barber_time_offs_tenant_id"`);
        await queryRunner.query(`DROP TABLE "barber_time_offs"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_working_hours_periods_wh_id"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_working_hours_barber_profile_id"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_working_hours_tenant_id"`);
