...
export class CreateTenantUserTable1772130000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."tenant_users_role_enum" AS ENUM('OWNER', 'ADMIN', 'BARBER', 'STAFF')`);
        await queryRunner.query(`CREATE TYPE "public"."tenant_users_status_enum" AS ENUM('ACTIVE', 'INACTIVE')`);
        await queryRunner.query(`CREATE TABLE "tenant_users" (
        ...
        await queryRunner.query(`CREATE UNIQUE INDEX "UQ_tenant_users_tenant_id_user_id" ON "tenant_users" ("tenant_id", "user_id")`);
    }
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX "public"."UQ_tenant_users_tenant_id_user_id"`);
